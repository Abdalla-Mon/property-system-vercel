...
-- CreateEnum
CREATE TYPE "PayEvery" AS ENUM ('ONCE', 'TWO_MONTHS', 'FOUR_MONTHS', 'SIX_MONTHS', 'ONE_YEAR');

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'USER');

-- CreateEnum
CREATE TYPE "PrivilegeArea" AS ENUM ('PROPERTY', 'UNIT', 'CLIENT', 'SETTING', 'RENT_AGREEMENT', 'BILLING');
